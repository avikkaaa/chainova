...
> Note: this version is UI/frontend only — wallet connection and smart contract integration (e.g. via ethers.js or wagmi) are planned next steps, not yet implemented.
